...
const List = () => {
    ...
    return (
        <View className='flex-1 bg-[#141439]  items-center justify-center relative'>
                ...
                <View className='flex flex-col px-4 '>
                    {
                        data.map((item, index) => {
                            return (
                                <View key={index} className='flex flex-row w-full  justify-between items-center px-4  py-6 bg-[#282854] my-2 rounded-lg'>
